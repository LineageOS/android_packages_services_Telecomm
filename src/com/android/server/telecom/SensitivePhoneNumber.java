...
public class SensitivePhoneNumber {
    ...
    public static SensitivePhoneNumber readSensitivePhoneNumbers (XmlPullParser parser) throws XmlPullParserException, IOException {
    ...
    private static ArrayList<String> readPhoneNumber (XmlPullParser parser) throws XmlPullParserException, IOException {
